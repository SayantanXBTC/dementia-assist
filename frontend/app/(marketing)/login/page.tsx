    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden>
        ...
        <div className="absolute bottom-0 right-0 w-80 h-80 rounded-full animate-float-slow"
             style={{ background: 'radial-gradient(circle,rgba(253,223,196,0.5) 0%,transparent 70%)', filter: 'blur(55px)' }} />
      </div>
      ...
      >
        ...
        <motion.div variants={fadeUp} custom={0}
          ...
          <div className="text-center mb-8">
            ...
            <p className="font-dm-sans text-text-mid text-sm mt-1">Welcome back — you&apos;ve been missed.</p>
          </div>
